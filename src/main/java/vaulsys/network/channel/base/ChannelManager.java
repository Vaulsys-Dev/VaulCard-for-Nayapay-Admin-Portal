...
//					}
	...
	public List<Channel> loadFromDB() {
		...
		try {
			...
			//channelIds.add(ChannelCodes.WALLETADMINPORTAL);
			channelIds.add(ChannelCodes.WALLETSUPPORTPORTAL);
			channelIds.add(ChannelCodes.WALLETMERCHANTPORTALFINANCIAL);
			channelIds.add(ChannelCodes.WALLETMERCHANTPORTALNONFINANCIAL);
			channelIds.add(ChannelCodes.WALLETAPPNONFINANCIAL);
			...
			dbQuery = "from " + InputChannel.class.getName() + " c " +
					...
					"and channelId not in (:channelId) ";
