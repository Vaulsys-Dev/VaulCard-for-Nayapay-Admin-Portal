...
//    }
    ...
    public String getCardnolastdigits() { return cardnolastdigits; }
...
//    }
    ...
    public WalletCMSWsListingEntity copy(WalletCMSWsEntity cmsWsEntity) {
        ...
        this.setCardnolastdigits(cmsWsEntity.getCardnolastdigits());
        ...
        this.setForexbufferamount(cmsWsEntity.getForexbufferamount());
        // ==================================================================
    ...
    @Column(name = "INTL_TXN_FEE_PERCENT")
    private String internationaltxnfeepercent;

    @Column(name = "INTL_TXN_FEE_PERCENT_TAX")
    private String internationaltxnfeepercenttax;

    @Column(name = "INTL_TXN_FAILED_FEE_PERCENT")
    private String internationaltxnfailedfeepercent;

    @Column(name = "INTL_TXN_FAILED_FEE_PERC_TAX")
    ...
    public static List<WalletCMSWsListingEntity> mapObject(ResultSet RS_Exp_Data) {
        ArrayList mylist = new ArrayList();
        int count=0;
        try {
            while (RS_Exp_Data.next()) {
                count+=1;
                WalletCMSWsListingEntity e = new WalletCMSWsListingEntity();
                e.setId(RS_Exp_Data.getLong("id"));
                e.setAccesstoken(RS_Exp_Data.getString("usertoken"));
                e.setAccountcurrency(RS_Exp_Data.getString("accountcurrency"));
                e.setAccountnumber(RS_Exp_Data.getString("accountnumber"));
                e.setAcctStatus(RS_Exp_Data.getString("acctstatus"));
                e.setAcctalias(RS_Exp_Data.getString("acct_alias"));
                e.setAcctbalance(RS_Exp_Data.getString("acctbalance"));
                e.setAcctid(RS_Exp_Data.getString("acctid"));
                e.setAcctlimit(RS_Exp_Data.getString("acctlimit"));
                e.setAcqbin(RS_Exp_Data.getString("acqbin"));
                e.setAcqcountrycode(RS_Exp_Data.getString("acq_country"));
                e.setActivationtime(RS_Exp_Data.getString("activationtime"));
                e.setAddress(RS_Exp_Data.getString("address"));
                e.setAdvanceflag(RS_Exp_Data.getString("advanceflag"));
                e.setAgentid(RS_Exp_Data.getString("agentid"));
                e.setAllowed(RS_Exp_Data.getString("allowed"));
                e.setAmounttransaction(RS_Exp_Data.getString("amounttran"));
                e.setAmtafterduedate(RS_Exp_Data.getString("amtafterduedate"));
                e.setAmtpaid(RS_Exp_Data.getString("amountpaid"));
                e.setAmttranfee(RS_Exp_Data.getString("amttranfee"));
                e.setAmtwithinduedate(RS_Exp_Data.getString("amtwithinduedate"));
                e.setAtmid(RS_Exp_Data.getString("atmid"));
                e.setAvaillimit(RS_Exp_Data.getString("availlimit"));
                e.setAvaillimitfreq(RS_Exp_Data.getString("availlimitfreq"));
                e.setBankcharges(RS_Exp_Data.getString("bankcharges"));
                e.setBankcode(RS_Exp_Data.getString("bankcode"));
                e.setBankmnemonic(RS_Exp_Data.getString("bank_mnemonic"));
                e.setBankname(RS_Exp_Data.getString("bankname"));
                e.setBanktaxamount(RS_Exp_Data.getString("banktaxamount"));
                e.setBanktxnflag(RS_Exp_Data.getString("banktxnflag"));
                e.setBeneaccountalias(RS_Exp_Data.getString("bene_acct_alias"));
                e.setBeneaccounttitle(RS_Exp_Data.getString("bene_acct_title"));
                e.setBenebankaccountno(RS_Exp_Data.getString("bene_bank_acct_no"));
                e.setBenebankcode(RS_Exp_Data.getString("bene_bank_code"));
                e.setBeneemailid(RS_Exp_Data.getString("bene_email_id"));
                e.setBeneflag(RS_Exp_Data.getString("bene_flag"));
                e.setBeneid(RS_Exp_Data.getString("beneficiary_id"));
                e.setBenemobileno(RS_Exp_Data.getString("bene_mobile_no"));
                e.setBillerid(RS_Exp_Data.getString("biller_id"));
                e.setBillername(RS_Exp_Data.getString("biller_name"));
                e.setBillingmonth(RS_Exp_Data.getString("billingmonth"));
                e.setBillstatus(RS_Exp_Data.getString("billstatus"));
                e.setBlockedflag(RS_Exp_Data.getString("blockedflag"));
                e.setBlocktype(RS_Exp_Data.getString("block_type"));
                e.setBranchcode(RS_Exp_Data.getString("branchcode"));
                e.setBranchname(RS_Exp_Data.getString("branchname"));
                e.setCardexpiry(RS_Exp_Data.getString("cardexpiry"));
                e.setCardnolastdigits(RS_Exp_Data.getString("cardnolastdigits"));
                e.setCardnumber(RS_Exp_Data.getString("cardnumber"));
                e.setCardscheme(RS_Exp_Data.getString("card_scheme"));
                e.setCardtype(RS_Exp_Data.getString("card_type"));
                e.setCategoryid(RS_Exp_Data.getString("merchantcategoryid"));
                e.setCategoryname(RS_Exp_Data.getString("categoryname"));
                e.setCbillamount(RS_Exp_Data.getString("cbill_amt"));
                e.setCbillcurrency(RS_Exp_Data.getString("cbill_curr"));
                e.setCbillrate(RS_Exp_Data.getString("cbill_rate"));
                e.setChannelid(RS_Exp_Data.getString("channelid"));
                e.setCiphereddata(RS_Exp_Data.getString("ciphereddata"));
                e.setCity(RS_Exp_Data.getString("city"));
                e.setCnic(RS_Exp_Data.getString("cnic"));
                e.setCnicexpiry(RS_Exp_Data.getString("cnicexpiry"));
                e.setCodflag(RS_Exp_Data.getString("codflag"));
                e.setComments(RS_Exp_Data.getString("comments"));
                e.setConsumerdetail(RS_Exp_Data.getString("consumerdetail"));
                e.setConsumerno(RS_Exp_Data.getString("consumerno"));
                e.setCoreaccount(RS_Exp_Data.getString("coreaccount"));
                e.setCoreaccountcurrency(RS_Exp_Data.getString("coreaccountcurrency"));
                e.setCorebankcode(RS_Exp_Data.getString("corebankcode"));
                e.setCountry(RS_Exp_Data.getString("country"));
                e.setCreationdate(RS_Exp_Data.getString("creationdate"));
                e.setCustomername(RS_Exp_Data.getString("customername"));
                //m.rehman: 27-06-2022, NAP-R3-22 - Change Management Release # 3, adding check for orig channel id
                e.setOrigChannelId(RS_Exp_Data.getString("destchannel"));
                ////////////////////////////////////////////////////////////////////////////////////////////////////////
                e.setDailylimit(RS_Exp_Data.getString("dailylimit"));
                e.setDateofbirth(RS_Exp_Data.getString("dateofbirth"));
                e.setDatepaid(RS_Exp_Data.getString("datepaid"));
                e.setDecryptedotp(RS_Exp_Data.getString("decryptedotp"));
                e.setDeletetype(RS_Exp_Data.getString("deletetype"));
                e.setDepositamount(RS_Exp_Data.getString("depositamount"));
                e.setDestaccount(RS_Exp_Data.getString("destaccount"));
                e.setDestaccountcurrency(RS_Exp_Data.getString("destaccountcurrency"));
                e.setDestbankcode(RS_Exp_Data.getString("destbankcode"));
                e.setDestchargeamount(RS_Exp_Data.getString("destamountcharge"));
                e.setDestinationchargetype(RS_Exp_Data.getString("destinationchargpe"));
                e.setDestnayapayid(RS_Exp_Data.getString("destnayapayid"));
                e.setDestuserid(RS_Exp_Data.getString("destuserid"));
                e.setDestusername(RS_Exp_Data.getString("destusername"));
                e.setDisputeflag(RS_Exp_Data.getString("dispute_flag"));
                e.setDuedate(RS_Exp_Data.getString("duedate"));
                e.setEnableflag(RS_Exp_Data.getString("enableflag"));
                e.setEncryptkey(RS_Exp_Data.getString("encryptedkey"));
                e.setEnddate(RS_Exp_Data.getString("enddate"));
                e.setFathername(RS_Exp_Data.getString("fathername"));
                e.setFinancialflag(RS_Exp_Data.getString("financial_flag"));
                e.setIban(RS_Exp_Data.getString("iban"));
                e.setIdentificationno(RS_Exp_Data.getString("identificationno"));
//                        e(RS_Exp_Data.getString("source_ip"));
                e.setInoutfilter(RS_Exp_Data.getString("inoutfilter"));
                e.setInvoiceid(RS_Exp_Data.getString("invoiceid"));
                e.setIsCashWithdrawalEnabled(RS_Exp_Data.getString("is_cash_withdrawal_enabled"));
                e.setIsChipPinEnabled(RS_Exp_Data.getString("is_chip_pin_enabled"));
                e.setIsInternationalTxnsEnabled(RS_Exp_Data.getString("is_int_txns_enabled"));
                e.setIsMagStripeEnabled(RS_Exp_Data.getString("is_mag_stripe_enabled"));
                e.setIsNFCEnabled(RS_Exp_Data.getString("is_nfc_enabled"));
                e.setIsOnlineEnabled(RS_Exp_Data.getString("is_online_enabled"));
                e.setIsprimary(RS_Exp_Data.getString("isprimary"));
                e.setJustification(RS_Exp_Data.getString("justification"));
                e.setLockstate(RS_Exp_Data.getString("lock_state"));
                e.setMapid(RS_Exp_Data.getString("map_id"));
                e.setMaximumamount(RS_Exp_Data.getString("maximumamount"));
                e.setMerchantamount(RS_Exp_Data.getString("merchant_amt"));
                e.setMerchantblocked(RS_Exp_Data.getString("merchantblocked"));
                e.setMerchantenabled(RS_Exp_Data.getString("merchantenabled"));
                e.setMerchantid(RS_Exp_Data.getString("merchantid"));
                e.setMerchantname(RS_Exp_Data.getString("merchantname"));
                e.setMerchantstate(RS_Exp_Data.getString("MERCHANTSTATE"));
                e.setMinimumamount(RS_Exp_Data.getString("minimumamount"));
                e.setMobilenumber(RS_Exp_Data.getString("mobilenumber"));
                e.setMonthlylimit(RS_Exp_Data.getString("monthlylimit"));
                e.setMothername(RS_Exp_Data.getString("mothername"));
                e.setNayapaycharges(RS_Exp_Data.getString("nayapaycharges"));
                e.setNayapayid(RS_Exp_Data.getString("nayapayid"));
                e.setNayapaytaxamount(RS_Exp_Data.getString("nayapaytaxamount"));
                e.setNayapaytrantype(RS_Exp_Data.getString("nayapaytrantype"));
                e.setNayapaytxnid(RS_Exp_Data.getString("nayapaytxnid"));
                e.setNpappdownloadcount(RS_Exp_Data.getString("np_app_download_count"));
                e.setNpticket(RS_Exp_Data.getString("np_ticket_id"));
                e.setOccupation(RS_Exp_Data.getString("occupation"));
                e.setOrigdataelement(RS_Exp_Data.getString("orig_data_element"));
                e.setOriginalapi(RS_Exp_Data.getString("originalapi"));
                e.setOrigretrefno(RS_Exp_Data.getString("orig_ret_ref_no"));
                e.setOrigstan(RS_Exp_Data.getString("orig_stan"));
                e.setOrigtransdatetime(RS_Exp_Data.getString("orig_trans_date_time"));
                e.setOtp(RS_Exp_Data.getString("otp"));
                e.setPagecount(RS_Exp_Data.getString("page_count"));
                e.setPagesize(RS_Exp_Data.getString("page_size"));
                e.setParentid(RS_Exp_Data.getString("parentid"));
                e.setPartialflag(RS_Exp_Data.getString("partialflag"));
                e.setPhonenumber(RS_Exp_Data.getString("phonenumber"));
                e.setPing(RS_Exp_Data.getString("ping"));
                e.setPlaceofbirth(RS_Exp_Data.getString("placeofbirth"));
                e.setPosentrymode(RS_Exp_Data.getString("pos_ent_mode"));
                e.setPosinvoiceref(RS_Exp_Data.getString("pos_invoice_ref"));
                e.setProvince(RS_Exp_Data.getString("province"));
                e.setPurposeoftransaction(RS_Exp_Data.getString("purpose_of_txn"));
                e.setReferencenumber(RS_Exp_Data.getString("referencenumber"));
                e.setRequesttime(RS_Exp_Data.getString("requesttime"));
                e.setReserved(RS_Exp_Data.getString("reserved"));
                e.setRespcode(RS_Exp_Data.getString("respcode"));
                e.setRrn(RS_Exp_Data.getString("rrn"));
                e.setSearchtext(RS_Exp_Data.getString("searchtext"));
                e.setSecondarynumber(RS_Exp_Data.getString("secondarynumber"));
                e.setSecretquestion1(RS_Exp_Data.getString("secret_question_1"));
                e.setSecretquestion2(RS_Exp_Data.getString("secret_question_2"));
                e.setSecretquestionanswer1(RS_Exp_Data.getString("secret_quet_ans_1"));
                e.setSecretquestionanswer2(RS_Exp_Data.getString("secret_quet_ans_2"));
//                        e.setSecurityparams(RS_Exp_Data.getString("security_params"));
                e.setServicename(RS_Exp_Data.getString("servicename"));
                e.setSettlementamount(RS_Exp_Data.getString("settlement_amount"));
                e.setSettlementdelay(RS_Exp_Data.getString("settlement_delay"));
                e.setSettlementrate(RS_Exp_Data.getString("sett_rate"));
                e.setSlipnumber(RS_Exp_Data.getString("slipnumber"));
                e.setSourcechargetype(RS_Exp_Data.getString("sourcechargetype"));
                e.setSrcchargeamount(RS_Exp_Data.getString("srcamountcharge"));
                e.setStan(RS_Exp_Data.getString("stan"));
                e.setStartdate(RS_Exp_Data.getString("startdate"));
                e.setState(RS_Exp_Data.getString("state"));
                e.setStatus(RS_Exp_Data.getString("status"));
                e.setTellerid(RS_Exp_Data.getString("tellerid"));
                e.setTempblockflag(RS_Exp_Data.getString("tempblockflag"));
                e.setTerminalid(RS_Exp_Data.getString("terminalid"));
                e.setTermloc(RS_Exp_Data.getString("termloc"));
                e.setTotalamount(RS_Exp_Data.getString("totalamount"));
                e.setTotalcount(RS_Exp_Data.getString("total_count"));
                e.setTrackingid(RS_Exp_Data.getString("tracking_id"));
                e.setTranauthid(RS_Exp_Data.getString("tranauthid"));
                e.setTrancurrency(RS_Exp_Data.getString("trancurrency"));
                e.setTranrefnumber(RS_Exp_Data.getString("txnrefnum"));
                e.setTransactionlimit(RS_Exp_Data.getString("transactionlimit"));
                e.setTransdatetime(RS_Exp_Data.getString("transdatetime"));
                e.setTrustedflag(RS_Exp_Data.getString("trustedflag"));
                e.setTsp(RS_Exp_Data.getString("telecomsp"));
                e.setUserid(RS_Exp_Data.getString("userid"));
                e.setUsername(RS_Exp_Data.getString("username"));
                e.setUtilcompanyid(RS_Exp_Data.getString("utilcompanyid"));
                e.setVerifiedflag(RS_Exp_Data.getString("verifiedflag"));
                e.setVrolticket(RS_Exp_Data.getString("vrol_ticket_id"));
                e.setWithholdingtaxamount(RS_Exp_Data.getString("withholding_tax_amt"));
                e.setYearlylimit(RS_Exp_Data.getString("yearlylimit"));

                // Asim Shahzad, Date : 3rd Oct 2022, Tracking ID : NAP-R4-22
                e.setIsinternational(RS_Exp_Data.getString("INT_FLAG"));
                e.setAcqreferenceno(RS_Exp_Data.getString("ARN"));
                e.setCentralprocessingdate(RS_Exp_Data.getString("CPD"));
                e.setSchemetransactionid(RS_Exp_Data.getString("SCHEME_TXN_ID"));
                e.setSourceamount(RS_Exp_Data.getString("SRC_AMT"));
                e.setSourcecurrency(RS_Exp_Data.getString("SRC_CURRENCY"));
                // ==========================================================

                // Asim Shahzad, Date : 13th Jan 2023, Tracking ID : VP-NAP-202302021 / VC-NAP-202302021
                e.setForexbufferamount(RS_Exp_Data.getString("FOREX_BUFFER_AMOUNT"));
                e.setIntltxnfee(RS_Exp_Data.getString("INTL_TXN_FEE"));
                e.setIntltxnfeetax(RS_Exp_Data.getString("INTL_TXN_FEE_TAX"));
                e.setNayapayinterbankusdrate(RS_Exp_Data.getString("NAYAPAY_INTER_BANK_USD_RATE"));
                e.setSettbankspread(RS_Exp_Data.getString("SETT_BANK_SPREAD"));
                e.setNayapayrevenuebuffer(RS_Exp_Data.getString("NAYAPAY_REVENUE_BUFFER"));
                e.setIntltxnfeeinusd(RS_Exp_Data.getString("INTL_TXN_FEE_USD"));
                e.setInternationaltxnfailedfee(RS_Exp_Data.getString("INTL_TXN_FAILED_FEE")); // Asim Shahzad, Date : 11th May 2023, Tracking ID : VP-NAP-202302021 / VC-NAP-202302021
                // ==================================================================

                // Asim Shahzad, Date : 23rd May 2023, Tracking ID : NAP-P2-23
                e.setSchemeservicefeeamount(RS_Exp_Data.getString("SCHEME_SERVICE_FEE_AMOUNT"));
                e.setSchemeinterchangerevenueamount(RS_Exp_Data.getString("SCHEME_INTERCHNG_REVENUE_AMT")); // Asim Shahzad, Date : 12th Sep 2023, Tracking ID : VP-NAP-202309053
                // ===========================================================

                // m.waleed, Date : 14th July 2023, Tracking ID : FW: VC-NAP-202306021 ==> [ Logging email ] ==> New API Calls GetCharges and PayCharges
                e.setOperationtype(RS_Exp_Data.getString("OPERATION_TYPE"));
				// ===========================================================

                //Added by m.waleed 18/08/2023 FW: VP-NAP-202308011==> [ Logging email ] ==> Variable Int'l txn Fee in Percentage Addition via Portal and in Transaction Processing
                e.setInternationaltxnfeepercent(RS_Exp_Data.getString("INTL_TXN_FEE_PERCENT"));
                e.setInternationaltxnfeepercenttax(RS_Exp_Data.getString("INTL_TXN_FEE_PERCENT_TAX"));
                e.setInternationaltxnfailedfeepercent(RS_Exp_Data.getString("INTL_TXN_FAILED_FEE_PERCENT"));
                e.setInternationaltxnfailedfeepercenttax(RS_Exp_Data.getString("INTL_TXN_FAILED_FEE_PERC_TAX"));
                // ===========================================================

                // Hritik Kumar, Date : 22nd Nov 2023, Tracking ID : RE: NAP-P2-23 ==> Chinese Aggregator Project - Nayapay - AliPay Testing Issue
                e.setExchangeRate(RS_Exp_Data.getString("exchange_rate"));
                // ================================================================

                //Hritik Kumar, Date : 31st October 2023 Tracking ID:  RE: VP-NAP-202310161
                e.setCategoryid(RS_Exp_Data.getString("merchantcategoryid"));
                //=========================================================================

                mylist.add(e);
            }
            logger.info("resultset count : "+ count);
