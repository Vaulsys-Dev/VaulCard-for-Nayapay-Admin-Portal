...
//@Table(name = "WS_LOG")
//@Table(name = "WSLOG")
@Table(name = "WSLOG_COMPLIANCE") // Asim Shahzad, Date : 6th Oct 2021, Tracking ID : PS-VP-NAP-202109301 / PS-VC-NAP-202109301 / PS-VG-NAP-202109301
public class WalletCMSWsEntity implements IEntity<Long>, Cloneable {

    //Arsalan Akhter, Date: 02-Feb-2022, Ticket: VC-NAP-202202011(Wallet Statement Issue - Production)==========================================================

//    @Id
//    @GeneratedValue(generator="TXN_NF_WSLOG_SEQ-gen") // Asim Shahzad, Date : 6th Oct 2021, Tracking ID : PS-VP-NAP-202109301 / PS-VC-NAP-202109301 / PS-VG-NAP-202109301
//    @org.hibernate.annotations.GenericGenerator(name = "TXN_NF_WSLOG_SEQ-gen", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator", // Asim Shahzad, Date : 6th Oct 2021, Tracking ID : PS-VP-NAP-202109301 / PS-VC-NAP-202109301 / PS-VG-NAP-202109301
//            parameters = {
//                    @org.hibernate.annotations.Parameter(name = "optimizer", value = "pooled"),
//                    @org.hibernate.annotations.Parameter(name = "increment_size", value = "1"),
//                    @org.hibernate.annotations.Parameter(name = "sequence_name", value = "TXN_NF_WSLOG_SEQ") // Asim Shahzad, Date : 6th Oct 2021, Tracking ID : PS-VP-NAP-202109301 / PS-VC-NAP-202109301 / PS-VG-NAP-202109301
//            })
...
//    }
    ...
    public WalletCMSWsEntity copy() {
        ...
        // Asim Shahzad, Date : 13th Jan 2023, Tracking ID : VP-NAP-202301071
        wsEntity.setForexbufferamount(this.getForexbufferamount());
        // ==================================================================

        // Asim Shahzad, Date : 13th June 2023, Tracking : VP-NAP-202306131
        wsEntity.setAtlstatus(this.getAtlstatus());
        // ================================================================
    ...
    // Asim Shahzad, Date : 19th April 2022, Project ID : NAP-2-22

    @Transient
    private Boolean ismultiplemerchants;

    @Transient
    private List<String> listmerchants;

    public Boolean getIsmultiplemerchants() {
        return ismultiplemerchants;
    }

    public void setIsmultiplemerchants(Boolean ismultiplemerchants) {
        this.ismultiplemerchants = ismultiplemerchants;
    }

    public List<String> getListmerchants() {
        return listmerchants;
    }

    public void setListmerchants(List<String> listmerchants) {
    ...
    // Asim Shahzad, Date : 13th June 2023, Tracking ID : VP-NAP-202306131
    @Transient
    private Boolean atlstatus;
