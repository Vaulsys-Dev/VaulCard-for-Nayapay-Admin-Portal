...
//            }
    ...
    public static WalletCMSWsEntity processBalanceInquiry(WalletCMSWsEntity wsmodel)
    {
        ...
        {
            return WSOperation.ExecuteBalanceInquiry(wsmodel);
        }
    }
    ...
    public static WalletCMSWsEntity processCashWithDrawal(WalletCMSWsEntity wsmodel)
    {
        ...
        {
            return WSOperation.ExecuteCashWithDrawal(wsmodel);
        }
    }
    ...
    public static WalletCMSWsEntity processCardBasedReversal(WalletCMSWsEntity wsmodel)
    {
        ...
        {
            return WSOperation.ExecuteCardBasedReversal(wsmodel);
        }
    }
    ...
    public static WalletCMSWsEntity processAdminPortalGetUserTransactionList(WalletCMSWsEntity wsmodel)
    {
        ...
        else
        {
            ...
            return WSOperation.ExecuteAdminPortalGetUserTransactionListFromDB(wsmodel);
        }
    }
...
//    }
    ...
    public static WalletCMSWsEntity processGetCardNumber(WalletCMSWsEntity wsmodel)
    {
        return WSOperation.ExecuteGetCardNumber(wsmodel);
    }
    // =====================================================================================

    // Asim Shahzad, Date : 19th April 2022, Project ID : NAP-2-22
    public static WalletCMSWsEntity processBlockMerchantWallet(WalletCMSWsEntity wsmodel)
    {
        return WSOperation.ExecuteBlockMerchantWalletRequest(wsmodel);
    }
    // ===========================================================

    // Asim Shahzad, Date : 5th Feb 2023, Tracking ID : VP-NAP-202302021 / VC-NAP-202302021
    public static WalletCMSWsEntity processBlockAllDebitCards(WalletCMSWsEntity wsmodel)
    {
        logger.info("Verifying EncryptedKey...");
        if(!WSOperation.ValidateEncryptedKey(wsmodel))
        {
        ...
        {
            return WSOperation.ExecuteBlockAllDebitCards(wsmodel);
        }
    }
    // ====================================================================================
}
